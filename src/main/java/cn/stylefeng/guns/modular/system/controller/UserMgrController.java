...
public class UserMgrController extends BaseController {
    ...
    public void getOssUrl() {
    	...
    	//				   http://linbinweb.oss-cn-beijing.aliyuncs.com/baobao    //上传文件后的文件路径
    	// 阿里云主账号AccessKey拥有所有API的访问权限，风险很高。强烈建议您创建并使用RAM账号进行API访问或日常运维，请登录 https://ram.console.aliyun.com 创建RAM账号。
    	String accessKeyId = "LTAId6e6uFZTjT7r";
    	String accessKeySecret = "HnlfJ7tLh5VWsOFhEct5CZfuj2clNc";
    	String bucketName = "linbinweb";
    	String objectName = "baobao";
